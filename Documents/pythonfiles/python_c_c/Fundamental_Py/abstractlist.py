...
from abstractcollectin import AbstractCollection
...
class AbstractList(AbstractCollection):
	...
	def getModCount(self):
		"""Returns the count of midifications to the list."""
		return self._modCount

	def incModCount(self):
		"""Increments the count of midifications
		to the list."""
		self._modCount += 1
	...
	def remove(self, item):
		...
		Raises: ValueError if itme is not in self.
